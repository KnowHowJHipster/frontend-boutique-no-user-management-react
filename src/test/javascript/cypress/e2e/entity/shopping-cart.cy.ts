...
describe('ShoppingCart e2e test', () => {
  ...
  const shoppingCartSample = { placedDate: '2024-06-03T17:42:23.212Z', status: 'COMPLETED', totalPrice: 8605.33, paymentMethod: 'IDEAL' };
  ...
  beforeEach(() => {
    ...
    cy.authenticatedRequest({
      ...
      body: {
        gender: 'MALE',
        phone: '563-616-8561 x22425',
        addressLine1: 'lowball',
        addressLine2: 'recapitulation',
        city: 'Lake Karley',
  ...
  describe('new ShoppingCart page', () => {
    ...
    it('should create an instance of ShoppingCart', () => {
      cy.get(`[data-cy="placedDate"]`).type('2024-06-04T03:45');
      cy.get(`[data-cy="placedDate"]`).blur();
      cy.get(`[data-cy="placedDate"]`).should('have.value', '2024-06-04T03:45');
